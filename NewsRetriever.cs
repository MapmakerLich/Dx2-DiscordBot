                ...
                if (chnl != null && canSend)
                {
                    try
                    {
                        if (ni.Image != null)
                        {
                            ...
                            {
                                var ext = ".png";
                                client.DownloadFile(new Uri(ni.Image), "newsbanner" + ext);
                                if (File.Exists("newsbanner.png"))
                                {
                                    await chnl.SendFileAsync("newsbanner" + ext, $"**{ni.Title}**\n{ni.Url}");
                                    File.Delete("newsbanner.png");
                                }
                                else
